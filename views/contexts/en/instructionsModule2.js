module.exports = function(settings, headers) {
    ...
    return {
        ...
        b:  "In each one-minute stage you will be asked to compute a series of additions. Your Preliminary Gains depend on how many correct answers you provide. If you are type G, you will get "+salaryG+" ECUs for each correct answer, while if you are type K you will get "+salaryK+" ECUs for each correct answer.",
        ...
        d:  "In each round there is a certain probability that your Declared Gains will be compared with your actual Preliminary Gains in order to verify these two amounts correspond. In this module this probability is 0%.",
        ...
        ifYouUnderstood: "If you understand the instructions, click \"Start Module 2\" ",
        proceed: "Start Module 2"
    };
};
/**
