module.exports = function(settings, headers) {
    ...
    return {
        ...
        instructions: "Module " + moduleNumber,
        ...
        b:  "The sort of decisions you are going to make are the following: Decision 1,  Option A pays $1.00 with probability of 10%, and it pays $0.80 with probability 90%. Option B pays $1.97 with probability of 10%, and it pays $0.05 with probability of 90%. The other Decisions are similar, except the chances of the higher payoff for each option increase. In fact, for Decision 10, the second selection will not be needed since each option pays the highest payoff for sure, so your choice here is between $1.00 and $1.97.",
        ...
        proceed: "Start Module " + moduleNumber
    };
};
